...
import { isMobileDevice } from '../../lib/utils/trackDevice'
...
export const Player = ({
  ...
  useFrame(() => {
    ...
    offset
      ...
      .multiply(
        isMobileDevice()
          ? speed.clone().multiplyScalar(12)
          : speed.clone().multiplyScalar(5)
      )
      .applyQuaternion(yaw)
  ...
  let playerPosition = isMobileDevice() ? [10, 3, 270] : [2, 3, 100]
  return (
    <RigidBody
      ref={api}
      lockRotations
